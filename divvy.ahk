...
NumpadEnd::  moveWindow("lower", "left")
NumpadDown:: moveWindow("lower", "wide")
NumpadPgDn:: moveWindow("lower", "right")
NumpadLeft:: moveWindow("tall", "left")
NumpadClear::moveWindow("tall", "wide")
NumpadRight::moveWindow("tall", "right")
NumpadHome:: moveWindow("upper", "left")
NumpadUp::   moveWindow("upper", "wide")
NumpadPgUp:: moveWindow("upper", "right")


Numpad1::moveWindow("lower", "left")
Numpad2::moveWindow("lower", "wide")
Numpad3::moveWindow("lower", "right")
Numpad4::moveWindow("tall", "left")
Numpad5::moveWindow("tall", "wide")
Numpad6::moveWindow("tall", "right")
Numpad7::moveWindow("upper", "left")
Numpad8::moveWindow("upper", "wide")
Numpad9::moveWindow("upper", "right")
